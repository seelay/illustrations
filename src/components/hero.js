        ...
        <div className="hero_wrapper">
          ...
          <div className="hero_details">
            <div className="texts">
              ...
              <p><strong>50 awesome illustrations</strong> (addeding more...) You can download all illustrations completely <strong>free</strong> and <strong>use</strong> these to design awesome - landing pages, mobile app or presentations. - Aman Seelay</p>
            </div>
